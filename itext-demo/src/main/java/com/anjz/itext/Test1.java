...
public class Test1 {
	...
	public void fillTemplate() throws IOException, DocumentException {
		PdfReader reader = new PdfReader("/Users/dingshuai/Desktop/5551.pdf"); // 模版文件目录
		PdfStamper ps = new PdfStamper(reader, new FileOutputStream("/Users/dingshuai/Desktop/5551111.pdf")); // 生成的输出流
