...
public class PdfExportService {
	...
	public void exportProtocolPdf(OutputStream out){
		...
		try {
			...
			logger.error("pdf product exception:",e);
		} finally {
			document.close();
		}
	}
	 ...
	 */
	private  void addTable(Document document,List<RecordModel> contentList,int column) throws DocumentException{
	 ...
	 * @return
	 */
	private PdfPTable getOneColumeTable(List<String> contentList){
